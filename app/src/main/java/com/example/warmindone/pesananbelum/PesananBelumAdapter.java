...
public class PesananBelumAdapter extends RecyclerView.Adapter<PesananBelumAdapter.ViewHolder> {
    ...
    public PesananBelumAdapter(Context context, List<PesananBelumModel> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.pesananbelum_widget, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        PesananBelumModel model = list.get(position);
