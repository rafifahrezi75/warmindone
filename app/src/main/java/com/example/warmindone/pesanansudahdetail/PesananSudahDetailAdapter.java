...
public class PesananSudahDetailAdapter
        extends RecyclerView.Adapter<PesananSudahDetailAdapter.ViewHolder> {

    private final ArrayList<PesananSudahDetailModel> list;

    public PesananSudahDetailAdapter(
            ArrayList<PesananSudahDetailModel> list
    ) {
        this.list = list;
    }
